...
`cloud-itonami-gtin-issuance` accepts contributions to the OSS actor, governor tests,
...
- Keep production writes behind the GTIN Allocation Governor.
- Treat GS1 prefix and GTIN allocation as a data-integrity-sensitive domain: add tests for
