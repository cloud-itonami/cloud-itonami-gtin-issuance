...
`cloud-itonami-gtin-issuance` is an OSS open-business blueprint. Governance covers both code
...
- the advisor cannot directly commit an unvalidated identifier or product
  record.
- the GTIN Allocation Governor remains independent of the advisor.
